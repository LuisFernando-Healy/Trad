public class Arboles {
    ...
    public static boolean validarFrase(String frase) {
        ...
        // Validamos cada palabra individualmente
        return esPalabraValida(tokens[0]) && 
               esPalabraValida(tokens[1]) && 
    ...
    private static boolean esPalabraValida(String palabra) {
        ...
        if (primeraLetra == 'a') return esPalabraConA(palabra);
        if (primeraLetra == 'c') return esPalabraConC(palabra);
        if (primeraLetra == 'e') return esPalabraConE(palabra); 
        if (primeraLetra == 'é') return esPalabraConE(palabra);
        if (primeraLetra == 'f') return esPalabraConF(palabra);
        if (primeraLetra == 'g') return esPalabraConG(palabra);
        if (primeraLetra == 'h') return esPalabraConH(palabra);
        if (primeraLetra == 'i') return esPalabraConI(palabra);
        if (primeraLetra == 'n') return esPalabraConN(palabra);
        if (primeraLetra == 'p') return esPalabraConP(palabra);
        if (primeraLetra == 'r') return esPalabraConR(palabra);
        if (primeraLetra == 's') return esPalabraConS(palabra);
        if (primeraLetra == 't') return esPalabraConT(palabra);
        if (primeraLetra == 'u') return esPalabraConU(palabra);
        if (primeraLetra == 'v') return esPalabraConV(palabra);
        if (primeraLetra == 'y') return esPalabraConY(palabra);
    ...
    private static boolean esPalabraConV(String p) {
        ...
        for (char l : p.toCharArray()) {
            ...
            // --- Cruce después de 'viv...' ---
            else if (e == 3 && l == 'o') e = 4; // Final: Vivo
            else if (e == 3 && l == 'e') e = 5; // Final: Vive
            else if (e == 5 && l == 's') e = 6; // Final: Vives
            else if (e == 5 && l == 'n') e = 7; // Final: Viven
            
            // Rama Vivimos
            else if (e == 3 && l == 'i') e = 8;
            else if (e == 8 && l == 'm') e = 9;
            else if (e == 9 && l == 'o') e = 10;
            else if (e == 10 && l == 's') e = 11; // Final: Vivimos
